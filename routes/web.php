...
Route::get('/registration', 'RegistrationController@showRegistration')->middleware('guest');
Route::post('/registration', 'RegistrationController@submitRegistration')->middleware('guest');

Route::get('/login', 'LoginController@showLogin')->middleware('guest')->name('login');
Route::post('/login', 'LoginController@submitLogin')->middleware('guest');
