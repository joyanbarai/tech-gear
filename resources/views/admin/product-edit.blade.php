...
@section('middle')
	...
	<div class="container">
      ...
      <div class="col-12 pt-1">
        <h4 class="text-center text-danger mb-3">Edit Product of <?php echo ucfirst($table);?><a href="/admin/product-control/view-product/{{ $table }}" class=" float-right btn btn-danger btn-sm"><i class="fas fa-backward"> Back</i></a></h4>
      </div>          
    </div>
        ...
        <div class="row">
          <div class="col-3">
            ...
            <img src="{{ $data[0]->Picture_1 }}" alt="No Image" height=100 width=100>
          ...
          <div class="col-3">           
            ...
            <img src="{{ $data[0]->Picture_2 }}" alt="No Image" height=100 width=100>
          ...
          <div class="col-3">            
            ...
            <img src="{{ $data[0]->Picture_3 }}" alt="No Image" height=100 width=100>
          ...
          <div class="col-3">
            ...
            <img src="{{ $data[0]->Picture_4 }}" alt="No Image" height=100 width=100>
        ...
        <div class="row">
          <div class="col-3">            
            ...
            <img src="{{ $data[0]->Picture_5 }}" alt="No Image" height=100 width=100>
          ...
          <div class="col-3">            
            ...
            <img src="{{ $data[0]->Picture_6 }}" alt="No Image" height=100 width=100>
