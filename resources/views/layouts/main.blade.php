		...
		<div class="header_top" style="background-color:gainsboro"><!--header_top-->
			<div class="container">
				<div class="row">
					<div class="col-6">						
						<ul class="nav">
							<li class="nav-item"><i class="fas fa-phone nav-link disabled">+88 01000000000</i></li>
							<li class="nav-item"><i class="fas fa-envelope nav-link disabled">info@techgear.com</i></li>
						</ul>						
					</div>
					<div class="col-6">
